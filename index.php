              ...
              <div class="box-body">
                  ...
                  <table class="table table-bordered">
                      <tr style="background-color:#6FACD5">
                          <td style="text-align:center"><b><?php if (isset($_POST['submit1'])){ echo Encipher($_POST['plain'],$key);} 
                  ...
                  <table class="table table-bordered">
                      <tr style="background-color:#6FACD5">
                          <td style="text-align:center"><b><?php if (isset($_POST['submit1'])){ echo Decipher(Encipher($_POST['plain'],$key),$key);} 
